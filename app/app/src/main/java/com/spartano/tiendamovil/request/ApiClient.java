...
public class ApiClient {
    ...
    //private static final String PATH="http://192.168.1.106:45456/api/"; //Sebastian
    ...
    public interface MyRetrofit {
        ...
        @GET("publicaciones/buscar") Call<List<Publicacion>> buscarPublicaciones(@Header("Authorization") String token,
                                                                                 ...
                                                                                 @Query("tipo") int tipo);
        @PUT("publicaciones/edit") Call<Void> editPublicacion(@Header("Authorization") String token, @Body Publicacion publicacion);
