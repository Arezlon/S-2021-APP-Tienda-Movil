...
public class MenuNavegacionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_inicio, R.id.nav_busqueda_avanzada, R.id.nav_nueva_publicacion, R.id.nav_perfil, R.id.nav_publicaciones, R.id.nav_fondos, R.id.nav_mensajes, R.id.nav_salir)
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                navController.navigate(R.id.nav_nueva_publicacion);
            }
        });
    }
